...
текст оказывается в активном поле. Собран под **KDE Plasma на Wayland**, где
обычные средства диктовки не работают.
...
![Whisper](https://img.shields.io/badge/whisper-облако_+_локально-e5a50a?style=flat-square)
